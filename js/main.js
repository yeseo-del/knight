...
const jobBaseData = {
    ...
    "Farmer": {name: "Farmer", maxXp: 1, income: 9},
    "Fisherman": {name: "Fisherman", maxXp: 1, income: 15},
    "Miner": {name: "Miner", maxXp: 1, income: 40},
    "Blacksmith": {name: "Blacksmith", maxXp: 1, income: 80},
    "Merchant": {name: "Merchant", maxXp: 1, income: 150},

    "Squire": {name: "Squire", maxXp: 1, income: 5},
    "Footman": {name: "Footman", maxXp: 1, income: 50},
    "Veteran footman": {name: "Veteran footman", maxXp: 1, income: 120},
    "Knight": {name: "Knight", maxXp: 1, income: 300},
    "Veteran knight": {name: "Veteran knight", maxXp: 1, income: 1000},
    "Elite knight": {name: "Elite knight", maxXp: 1, income: 3000},
    "Holy knight": {name: "Holy knight", maxXp: 1, income: 15000},
    "Legendary knight": {name: "Legendary knight", maxXp: 1, income: 50000},

    "Student": {name: "Student", maxXp: 1, income: 100},
    "Apprentice mage": {name: "Apprentice mage", maxXp: 1, income: 1000},
    "Mage": {name: "Mage", maxXp: 1, income: 7500},
    "Wizard": {name: "Wizard", maxXp: 1, income: 50000},
    "Master wizard": {name: "Master wizard", maxXp: 1, income: 250000},
    "Chairman": {name: "Chairman", maxXp: 1, income: 1000000},
}

const skillBaseData = {
    "Concentration": {name: "Concentration", maxXp: 1, effect: 0.01, description: "Skill xp"},
    "Productivity": {name: "Productivity", maxXp: 1, effect: 0.01, description: "Job xp"},
    "Bargaining": {name: "Bargaining", maxXp: 1, effect: -0.01, description: "Expenses"},
    "Meditation": {name: "Meditation", maxXp: 1, effect: 0.01, description: "Happiness"},

    "Strength": {name: "Strength", maxXp: 1, effect: 0.01, description: "Military pay"},
    "Battle tactics": {name: "Battle tactics", maxXp: 1, effect: 0.01, description: "Military xp"},
    "Muscle memory": {name: "Muscle memory", maxXp: 1, effect: 0.01, description: "Strength xp"},

    "Mana control": {name: "Mana control", maxXp: 1, effect: 0.01, description: "T.A.A. xp"},
    ...
    "Dark influence": {name: "Dark influence", maxXp: 1, effect: 0.01, description: "All xp"},
    "Evil control": {name: "Evil control", maxXp: 1, effect: 0.01, description: "Evil gain"},
    "Demon training": {name: "Demon training", maxXp: 1, effect: 0.02, description: "All xp"},
    "Blood meditation": {name: "Blood meditation", maxXp: 1, effect: 0.02, description: "Evil gain"},
